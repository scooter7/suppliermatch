...
def main():
    ...
    # Fetch CSV data for conversational querying
...
def find_matching_providers(summary):
    ...
    matching_providers = csv_data[csv_data['Primary Industry'].fillna('').apply(lambda industry: "advertising" in industry.lower())]
    
    return matching_providers

def get_text_chunks(csv_data):
    """Split CSV data into chunks for the vector store."""
...
def handle_userinput(user_question):
    """Handle user input and query the conversation model."""
...
def modify_response_language(original_response):
    """Modify the response to make it more conversational."""
